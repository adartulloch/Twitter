...
public class TwitterClient extends OAuthBaseClient {
	public static final BaseApi REST_API_INSTANCE = TwitterApi.instance(); //Twitter instance
	public static final String REST_URL = "https://api.twitter.com/1.1";   //Twitter REST URL
